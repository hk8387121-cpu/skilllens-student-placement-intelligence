...
class SkillLensML:
    ...
    def preprocess_data(self):
        ...
        if 'gender' in self.df.columns:
            self.df['gender'] = le.fit_transform(self.df['gender'].str.strip())
        if 'extracurricular_activities' in self.df.columns:
            self.df['extracurricular_activities'] = le.fit_transform(self.df['extracurricular_activities'].str.strip())
    ...
    def decision_tree_classification(self):
        ...
        # Proper 80/20 train/test split to prevent leakage
    ...
    def kmeans_clustering(self):
        ...
        sorted_indices = cluster_scores.argsort()[::-1]
